module.exports = {
	...
	ignorePatterns: [".eslintrc.js", "jest.config.js", "commitlint.config.js", "*.stories.svelte", "docs"],
	overrides: [
	  {
		files: ["*.svelte"],
	...
	rules: {
	  ...
	  "no-undef-init": "off",                                                    /* ( f) disallow initializing variables to `undefined` */ // Turned off because initializing props to undefined is how Svelte understands optional props
	  ...
	  "multiline-comment-style": "off",                                          /* ( f) enforce a particular style for multiline comments */ // Disabled because autofixing this doesn't work well
	  ...
	  "@typescript-eslint/explicit-function-return-type": "off",                 /* (  ) Require explicit return types on functions and class methods */ // Disabled because this breaks when specifying callbacks in HTML markup in .svelte files
	  ...
	  "@typescript-eslint/no-unnecessary-condition": "off",                      /* ( ft) Prevents conditionals where the type is always truthy or always falsy */ // Turned off because when checking for optional props (initialized to undefined), eslint will think its a falsy comparison
	  ...
	  "@typescript-eslint/no-unsafe-argument": "off",                            /* (  t) Disallows calling an function with an any type value */ // Disabled because this doesn't play nicely with svelte
