#!/bin/bash
# Build the Wasm
em++ src/main.cpp src/libastro/*.c -o ../svelte/src/lib/wasm/wasm.js --profiling -w -s WASM=1 --bind -O1 -std=c++11 --pre-js=pre.js --post-js=post.js -s EXPORTED_RUNTIME_METHODS='["ccall","cwrap","allocate"]'
